		...
		<div class="row">
			<div class="col-md-5 col-lg-3">
				<div class="nk-social-profile-avatar">
					<a href="#">
						<img src="{{ property_exists(Auth::user(), 'profile_pic') ? Auth::user()->profile_pic : asset('assets/images/avatar-1.jpg') }}"
						 alt="{{ config('app.name') }}">
					</a>
				</div>
			</div>
				...
				<div class="nk-social-profile-info">
					...
					<div class="nk-social-profile-info-username">
						@if(Auth::user()->is_online)
							@onlineChars(Auth::user()->charactersOnline->count())
						@else
							{{ trans('myaccount.game_account_no_characters_online') }}
						@endif
					</div>
					{{--
